...
GWAS data has rapidly grown due to the reduction in genotyping costs and the imputation of many non-genotyped SNPs. In 2007, there were datasets with 2000 cases and 3000 controls, genotyped over 300K SNPs. Now, we have datasets of 500K individuals, genotyped over 800K SNPs, and imputed over 90M SNPs.
Genotype data are the first data of the omics family to have grown to such large scale. To analyze these datasets, software have been consistently procuded or updated over the years in order to keep up with growing sizes. 
